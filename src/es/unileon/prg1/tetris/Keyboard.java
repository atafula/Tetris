...
/**
 * Clase que permite leer valores simples de la linea de comandos. Si ocurre un
 * error durante la lectura las excepciones lanzadas son capturadas y se retorna
 * el menor valor representable del tipo de datos leido.
 *
 * Nota: esta no es una muy buena opci?n de tratar los posibles errores. En
 * futuras versiones (cuendo se explique la gesti?n de excepciones) se mejorar?
 * este tratamiento.
 *
 * @version 1.0
 * @author PRG
...
public class Keyboard {
     ...
     *
     *
     * @return Retorna el valor introducido por el teclado. Si se introduce un valor
     *         que no es correcto se retorna el minimo valor representable en int
     *         (Integer.MIN_VALUE)
     * @see Integer
     */
     ...
     *
     * @return Retorna el valor introducido por el teclado. Si se introduce un valor
     *         que no es correcto se retorna el minimo valor representable en short
     *         (Short.MIN_VALUE)
     * @see Short
     */
     ...
     *
     * @return Retorna el valor introducido por el teclado. Si se introduce un valor
     *         que no es correcto se retorna el minimo valor representable en long
     *         (Long.MIN_VALUE)
     * @see Long
     */
     ...
     *
     * @return Retorna el valor introducido por el teclado. Si se introduce un valor
     *         que no es correcto se retorna el minimo valor representable en float
     *         (Float.MIN_VALUE)
     * @see Float
     *
     */
     ...
     *
     * @return Retorna el valor introducido por el teclado. Si se introduce un valor
     *         que no es correcto se retorna el minimo valor representable en double
     *         (Double.MIN_VALUE)
     * @see Double
     */
